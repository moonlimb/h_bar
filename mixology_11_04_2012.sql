...
INSERT INTO `drinks` VALUES (1,'vodka on the rocks','proton','2*1#1*2'),(2,'vodka on the rocks (stronger)','neutrons','1*1#2*2'),(3,'vodka bitters','lambda','1*1#1*2#1*3'),(4,'extra drink vodka martini','pion','1*1#1*8#1*2'),(5,'vodka bitters with cherry','kaon','1*2#1*9#1*3'),(6,'vodka martini','D','1*4#1*8#1*2'),(7,'sangria','B','1*1#1*11#1*5'),(8,'extra dry gin and vodka martini','H atom','2*1#1*2#1*13'),(9,'Whiskey, soda and lemon','decayed pion','1*14#1*17#1*20'),(10,'rum, coke and lime','decayed Z','1*15#1*18#1*21'),(11,'Gin, tonic and lemon','decayed W','1*13#1*16#1*20'),(12,'whiskey, gin, lime','Higgs boson','1*14#1*13#1*21'),(13,'The Manhattan project','Special : mu + c + anti-s','1*14#1*4#1*9#1*3'),(14,'Old fissioned','Special : mu + v_mu + anti-s + g','1*14#1*17#1*9#1*22#1*3'),(15,'Three Mile Long Island','Special : d + e + tau + gamma + v_tau','1*2#1*13#1*15#1*19#1*18'),(16,'Cosmos','Special : g + Z + d','1*2#1*21#1*22'),(17,'mu-York Cocktail','Special : mu + Z + g','1*14#1*21#1*22'),(18,'Mai_Tau','Special : Z + tau + g','1*15#1*21#1*22'),(19,'(Surely You\'re Joking) Mr. Feynman','Special: W + t-bar','1*12#1*20');
...
-- Dump completed on 2012-11-04 17:56:05
